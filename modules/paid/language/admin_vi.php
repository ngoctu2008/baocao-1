...
$lang_translator['author'] = 'Tuấn Phạm (tuanpb1988@gmail.com)';
$lang_translator['createdate'] = '15/02/2023, 15:38';
$lang_translator['copyright'] = '@Copyright (C) 2023 Tuấn Phạm All rights reserved';
$lang_translator['info'] = '';
$lang_translator['langtype'] = 'lang_module';

$lang_module['main'] = 'Trang chính';
$lang_module['import'] = 'Import dữ liệu';
$lang_module['upload'] = 'Upload file';
$lang_module['save'] = 'Lưu lại';

$lang_module['fv_assigned_to'] = 'Sale';
$lang_module['customer'] = 'Khách hàng';
$lang_module['status'] = 'Trạng thái';
$lang_module['note'] = 'Ghi chú';
$lang_module['ext_app_id'] = 'Số Hợp đồng';
$lang_module['c_scheme'] = 'Tên sản phẩm';
$lang_module['dpd'] = 'DPD';
$lang_module['allocationdate'] = 'Ngày đổ list';
$lang_module['installment_amt'] = 'Số tiền trả góp';
...
$lang_module['ext_app_id'] = 'Số hợp đồng';
$lang_module['c_scheme'] = 'Tên sản phẩm';
$lang_module['dpd'] = 'Số ngày chậm nợ';
$lang_module['allocationdate'] = 'Ngày đổ list';
$lang_module['installment_amt'] = 'Số tiền trả góp mỗi kỳ';
$lang_module['sale_code'] = 'Sale';
$lang_module['sale_email'] = 'Email sale';
